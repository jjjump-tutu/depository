...
config_list = construct_config(arg.length)
...
trainX, trainY, testX, testY = dataload(arg.dataset)

for config in config_list:
    log_file = "ResNet{}_{}.log".format(config.depth, config.conv_filter_length)
    ...
    model_name = os.path.join(model_dir,"ResNet{}_{}.h5".format(config.depth, config.conv_filter_length))
